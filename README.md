...
| 发现页 | 合集详情页 | 店铺列表与导航 |
| --- | --- | --- |
| <img src="docs/screenshots/discover.png" alt="发现美食地图" width="280"> | <img src="docs/screenshots/map-detail.jpg" alt="合集地图详情页" width="280"> | <img src="docs/screenshots/place-list.jpg" alt="店铺列表与导航" width="280"> |

> **发现页**：按城市（全部 / 佛山 / 深圳）筛选、按「最新 / 最热」排序，浏览全部公开美食合集。
